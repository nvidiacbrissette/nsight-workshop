...
CHECKPOINTS: dict[str, Checkpoint] = {
    ...
    "kernels": Checkpoint(
        name="kernels",
        description="Reference checkpoint with synchronization and kernel-launch fixes applied.",
        synchronization=solution_synchronization,
        ...
        defaults=checkpoint_defaults(
            "kernels",
            "Reference checkpoint with synchronization and kernel-launch fixes applied.",
        ),
    ),
    "handoff": Checkpoint(
        name="handoff",
        description="Reference checkpoint with synchronization, kernel-launch, and handoff fixes applied.",
        synchronization=solution_synchronization,
        short_kernels=solution_short_kernels,
        ...
        defaults=checkpoint_defaults(
            "handoff",
            "Reference checkpoint with synchronization, kernel-launch, and handoff fixes applied.",
        ),
    ),
    "io": Checkpoint(
        name="io",
