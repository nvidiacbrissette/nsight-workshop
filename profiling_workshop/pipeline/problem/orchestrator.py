...
from profiling_workshop.pipeline.problem import batching, handoffs, short_kernels, synchronization
...
DEFAULTS = PipelineDefaults(
    variant="problem",
    description="Original pipeline with trace-visible performance issues.",
    batches=128,
    batch_size=128,
    micro_batches=16,
    num_workers=0,
